...
export interface Deck {
  ...
  updatedAt?: Date; // Optional date when the deck was last updated
...
export const decks: Deck[] = [
  {
    ...
    createdAt: new Date("2025-11-27"), // Date when this deck was created
  ...
  },
  {
    ...
    createdAt: new Date("2024-12-19"), // Date when this deck was created
    updatedAt: new Date("2025-12-02"), // Date when this deck was last updated
    // imageUrl will be auto-generated by getDeckWithImage() function
  },
